...
public class API_StepDef_ProgramBatch {
	...
	public void admin_receives_ok_status_with_response_body_for_batch(Integer int1) throws FileNotFoundException {
	...
	public void admin_creates_put_request_with_valid_batch_id_and_data_for_batch() throws FileNotFoundException {
		// Write code here that turns the phrase above into concrete actions
		;
	}
